...
export default function SampleBreathingStart(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "SampleBreathingStart")}
    >
      <View
        width="340px"
        height="340px"
      ...
      <Flex
        ...
        {...getOverrideProps(
          overrides,
          "Device/Device frame components58722911"
        )}
      ></Flex>
      <View
        width="412px"
        ...
        {...getOverrideProps(
          overrides,
          "Device/Device frame components58722912"
        )}
      ></View>
      <Icon
        width="16px"
