...
export default function SampleCoughSec30(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "SampleCoughSec30")}
    >
      <View
        padding="0px 0px 0px 0px"
        width="343px"
      ...
      <Flex
        ...
        {...getOverrideProps(
          overrides,
          "Device/Device frame components58722848"
        )}
      ></Flex>
      <View
        width="412px"
        ...
        {...getOverrideProps(
          overrides,
          "Device/Device frame components58722849"
        )}
      ></View>
      <Icon
        width="16px"
      ...
      <View
        ...
        {...getOverrideProps(
          overrides,
          "VUI / Static / Attention State58722855"
        )}
      >
        <View
          padding="0px 0px 0px 0px"
          ...
          {...getOverrideProps(
            overrides,
            "VUI / Static / Attention State58722859"
          )}
        >
          <Image
            width="413px"
