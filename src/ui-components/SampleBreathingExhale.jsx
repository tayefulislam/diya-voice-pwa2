...
export default function SampleBreathingExhale(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "SampleBreathingExhale")}
    >
      <View
        width="343px"
        height="59px"
      ...
      <Flex
        ...
        {...getOverrideProps(
          overrides,
          "Device/Device frame components58722953"
        )}
      ></Flex>
      <View
        width="412px"
        ...
        {...getOverrideProps(
          overrides,
          "Device/Device frame components58722954"
        )}
      ></View>
      <Icon
        width="16px"
      ...
      <Text
        ...
        whiteSpace="pre-wrap"
        children="Exhale"
        {...getOverrideProps(overrides, "Exhale")}
      ></Text>
      <Image
        width="413px"
        height="237.8px"
