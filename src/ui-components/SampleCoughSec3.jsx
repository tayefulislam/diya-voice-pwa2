...
export default function SampleCoughSec3(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "SampleCoughSec3")}
    >
      <Flex
        gap="286px"
        position="absolute"
        ...
        {...getOverrideProps(
          overrides,
          "Device/Device frame components58722754"
        )}
      ></Flex>
      <View
        width="412px"
        ...
        {...getOverrideProps(
          overrides,
          "Device/Device frame components58722755"
        )}
      ></View>
      <Icon
        width="16px"
      ...
      <View
        ...
        {...getOverrideProps(
          overrides,
          "VUI / Static / Attention State58722765"
        )}
      >
        <View
          padding="0px 0px 0px 0px"
          ...
          {...getOverrideProps(
            overrides,
            "VUI / Static / Attention State58722769"
          )}
        >
          <Image
            width="413px"
