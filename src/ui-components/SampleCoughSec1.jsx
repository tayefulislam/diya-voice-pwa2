...
export default function SampleCoughSec1(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "SampleCoughSec1")}
    >
      <Flex
        gap="286px"
        position="absolute"
        ...
        {...getOverrideProps(
          overrides,
          "Device/Device frame components58722814"
        )}
      ></Flex>
      <View
        width="412px"
        ...
        {...getOverrideProps(
          overrides,
          "Device/Device frame components58722815"
        )}
      ></View>
      <Icon
        width="16px"
      ...
      <View
        ...
        {...getOverrideProps(
          overrides,
          "VUI / Static / Attention State58722825"
        )}
      >
        <View
          padding="0px 0px 0px 0px"
          ...
          {...getOverrideProps(
            overrides,
            "VUI / Static / Attention State58722829"
          )}
        >
          <Image
            width="413px"
